...
<header className='py-4 px-6 flex justify-between items-center gap-10'>
    ...
    ">
      ...
      <Link to={"/cart"} className="menu-link flex flex-col items-center hover:text-blue-600 hover:scale-105">
          ...
          <Link to={"/customers"} className="menu-link flex flex-col items-center hover:text-blue-600 hover:scale-105">
            <UserOutlined className="md:text-2xl text-xl" />
            <span className="md:text-xs text-[10px]">Müşteriler</span>
          </Link>
          <Link to={"/statistic"} className="menu-link flex flex-col items-center hover:text-blue-600 hover:scale-105">
